    ...
    outcomes: [
      {
        ...
        text: "Del otro lado no insistieron. A la semana siguiente vieron una foto del recital: otra banda ocupaba ese escenario. {randomBandMemberWithArticle} hizo un chiste diciendo que al menos no tuvieron que cargar los equipos. Nadie se rió demasiado.",
        tone: "negative",
        cta: "Seguir",
      ...
      },
      {
        ...
        text: "La banda decidió seguir esperando una fecha que los representara un poco más. Esa noche igual hubo ensayo. La mamá {randomBandMemberPossessive} apareció con una fuente de empanadas y {randomBandMemberWithArticle} se comió nueve.",
        tone: "neutral",
        cta: "Seguir",
  ...
  },
  {
    ...
    outcomes: [
      ...
      },
      {
        ...
        text: 'La discusión duró tanto que el dueño del bar volvió a llamar tres veces. A la cuarta, {randomBandMemberWithArticle} atendió haciéndose pasar por el manager porque le daba vergüenza decir que seguían decidiendo. El "manager" confirmó la fecha.',
        tone: "positive",
        cta: "Seguir",
